...
<head>
    ...
    <title>Admin Login - ITSO Student Link</title>
    ...
    <div class="login-container">
        ...
        <div class="form-section">
            <form class="login-form" id="login-form" method="post" action="includes/login.inc.php">
                ...
                <input type="hidden" name="login_type" value="<?php echo isset($_SESSION['form_data']['login_type']) ? $_SESSION['form_data']['login_type'] : 'admin'; ?>">
